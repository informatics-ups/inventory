...
import { scrollToId } from "@/lib/hooks/scrollToId";
...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Hero Content */}
      <div className="relative z-20 max-w-4xl px-6 xl:px-16">
        <Badge
          variant="outline"
        ...
        <h1 className="font-headline text-5xl md:text-7xl font-extrabold tracking-tighter text-on-surface mb-4 leading-tight">
          ...
          <span className="bg-linear-(--signature-gradient) text-transparent bg-clip-text">
            {t("tagline").split(".").slice(2).join(".").trim() ||
              "Run the Lab."}
          </span>
        </h1>
        ...
        <div className="flex flex-wrap gap-4">
          <Button
            onClick={() => scrollToId("borrow-status")}
          ...
          <Button
            variant="outline"
            onClick={() => scrollToId("inventory-overview")}
